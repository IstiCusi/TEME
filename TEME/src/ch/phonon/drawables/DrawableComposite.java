...
/**
 * The {@link DrawableComposite} class allows to group {@link Drawables} to one
 * Drawable, what allows to construct more complex shapes. It fulfills the 
 * contract of a normal {@link Drawable}. The {@link #contains(int, int)} function
 * checks if one of the {@link Drawable}s contains the point. 
 * 
 * @author phonon
 *
 */
public class DrawableComposite implements Drawable {
	...
	/**
	 * This method is used to add {@link Drawable}s to the {@link DrawableComposite}. 
	 * 
	 * @param drawable
	 */
	...
	/**
	 * This function removes by reference not by value, when the Drawables
	 * do not implement the equals method. Maybe we should add a index based 
