...
public class StarPointTest {
	...
	public void testCreateRotatedStarPoint() {
		...
		StarPoint newStarPoint = StarPoint
				.createRotatedStarPoint(originalStarPoint, Math.toRadians(+90));
		assertNotSame("Not a new object was created", originalStarPoint,
				newStarPoint);
	...
	public void testGetAngle() {
		...
		assertEquals(90, result, epsilon);
		assertEquals(StarPoint.getAngle(a, b), StarPoint.getAngle(b, a),
				epsilon);
